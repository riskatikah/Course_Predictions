...
def predict_course(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Simpan input pengguna ke dalam UserInput model
            ...
            user_input.save()  # Menyimpan data ke database

            model_path = os.path.join(settings.BASE_DIR, 'save_model', 'riska', 'svm_model.pkl')
            try:
            ...
            return render(request, 'Learnlytics/course.html', {
                'form': form,
    ...
    return render(request, 'Learnlytics/course.html', {'form': form})
